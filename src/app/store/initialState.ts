...
export const baseInitialState: RRState = {
  ...
  tiers: [
    { id: 'seed',   emoji: '🌱', name: 'Zaadjes', nameEn: 'Seed',   en: 'Seed',   min: 0,    max: 2499, mult: '1×',   routes: ['Standaard startpunt voor elk lid'],                                                                              routesEn: ['Standard starting point for every member'], tagline: 'Instap · alle klanten', taglineEn: 'Entry · all customers', benefits: ['1% korting op je BudgetThuis-rekening', '1 boom geplant op jouw naam'], benefitsEn: ['1% discount on your BudgetThuis bill', '1 tree planted in your name'] },
    { id: 'tree',   emoji: '🌳', name: 'Boom', nameEn: 'Tree',   en: 'Tree',   min: 2500, max: 5999, mult: '1,5×', routes: ['2.500 seeds verzameld', 'of 12 maanden actief klant'],                                                           routesEn: ['2,500 seeds collected', 'or 12 months as an active customer'], tagline: 'Actief & multi-product', taglineEn: 'Engaged & multi-product', benefits: ['1,5× seed-multiplier', '3% korting op je rekening', 'Voorrang bij klantenservice'], benefitsEn: ['1.5x seed multiplier', '3% discount on your bill', 'Priority customer service'] },
    { id: 'forest', emoji: '🌲', name: 'Bos',  nameEn: 'Forest', en: 'Forest', min: 6000, max: null, mult: '2×',   routes: ['6.000 seeds verzameld', 'of 2+ producten + zonnepanelen', 'of 36 maanden actief klant'], routesEn: ['6,000 seeds collected', 'or 2+ products + solar panels', 'or 36 months as an active customer'], tagline: 'Meest loyale klanten', taglineEn: 'Most loyal customers', benefits: ['2× seed-multiplier', '5% korting op je rekening', 'Voorrang bij klantenservice', 'Jaarlijkse verrassingsbeloning'], benefitsEn: ['2x seed multiplier', '5% discount on your bill', 'Priority customer service', 'Annual surprise reward'] },
  ],
  currentTier: 'seed',
  ...
  catalogue: [
    ...
    { cat: 'Internet bonussen', catEn: 'Internet benefits', parentProduct: 'Internet', items: [
      { name: 'Internet 50 Mbps',    nameEn: 'Internet 50 Mbps',    seeds: 15, status: 'claimed',   group: 'internet-speed' },
    ...
    { cat: 'Mobiel bonussen', catEn: 'Mobile benefits', parentProduct: 'Mobiel', items: [
      ...
      { name: 'Databundel 5 GB',   nameEn: '5 GB data bundle',   seeds: 15,  status: 'claimed',   group: 'mobile-bundle' },
